...
My audio mechanic gives the reconstructed pixel version of *The Starry Night* a living rhythm. Using FFT and amplitude analysis, I map sound energy to the lower region of the composition, especially the village and tree area, so this part feels active rather than static. Louder moments increase brightness pulses and pixel density, while softer moments produce calmer movement and subtle glow transitions. Users interact by playing different tracks and hearing how visual behavior changes in real time. This supports our shared-canvas vision because each mechanic controls a different region: randomness shapes stars, input controls sky flow, and audio animates the grounded elements. My goal is to add atmosphere and “human life” to the painting through responsive, music-driven motion while preserving visual coherence.
